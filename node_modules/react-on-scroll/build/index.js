...
var OnScroll = function (_React$Component) {
	...
	function OnScroll(props) {
		...
		_this.onScroll = function () {
			var _getElementPosition = getElementPosition(_this.element),
			    fromTop = _getElementPosition.fromTop,
			    fromBottom = _getElementPosition.fromBottom;
			...
			var nextTriggers = _this.triggers.map(function (trigger) {
				...
				if (!triggerBase) {
					...
					currentState = (typeof trigger.bottom === 'undefined' || trigger.bottom < fromBottom[triggerBase]) && (typeof trigger.top === 'undefined' || trigger.top < fromTop[triggerBase]);
				}
